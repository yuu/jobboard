...
import Initial from 'src/components/common/Initial'
...
const Preview = ({ mainPreview = false }) => {
  ...
  // job contexts data
  const { jobTitle, jobType, jobArea, jobDescription, jobLink, date } = useContext(HireContext)

  // company contexts data
  const { companyName, companyEmail, companyWebsite, companyDescription } = useContext(HireContext)
  ...
  return (
    <div className={styles.preview_container}>
      ...
      <div className={styles.btn}>
        {!mainPreview && <Button label='Post Job' onClick={handlePostJob} />}
        {mainPreview && (
